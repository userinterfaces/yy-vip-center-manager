class Goods_Edit_Modal extends React.Component {
	...
	render() {
		return (
			React.createElement("div", {className: "modal fade", id: "goods_Edit_Modal", tabindex: "-1", role: "dialog", "aria-hidden": "true"}, 
				React.createElement("div", {className: "modal-dialog"}, 
					React.createElement("div", {className: "modal-content"}, 
						React.createElement("div", {className: "modal-header"}, 
							React.createElement("button", {type: "button", className: "close", "data-dismiss": "modal", "aria-hidden": "true"}, "×"), 
							React.createElement("h4", null, "编辑商品")
						), 
...
var goods_Edit_Modal = ReactDOM.render(React.createElement(Goods_Edit_Modal, null), $("<div></div>").appendTo(document.body)[0]);
